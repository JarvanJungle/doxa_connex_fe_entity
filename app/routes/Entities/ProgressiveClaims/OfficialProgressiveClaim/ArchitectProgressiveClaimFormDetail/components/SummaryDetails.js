                ...
                <Row>
                    ...
                    <Col xs={12}>
                        <HorizontalInput
                            ...
                            type="text"
                            value={`${values?.currencyCode} ${formatNumberForRow({ value: values.originalContractSum })}`}
                            disabled
                        />
                        {
                             ...
                             && (
                                 <>
                                     <HorizontalInput
                                         ...
                                         type="text"
                                         value={`${values?.currencyCode} ${formatNumberForRow({ value: values.bqContingencySum })}`}
                                         disabled
                                     ...
                                     <HorizontalInput
                                         ...
                                         type="text"
                                         value={`${values?.currencyCode} ${formatNumberForRow({ value: values.remeasuredContractSum })}`}
                                         disabled
                                     />
                                 </>
                             )
